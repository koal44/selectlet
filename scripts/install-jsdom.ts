    ...
    postInstall(dir) {
      ...
      writeFileSync(
        ...
        [
          ...
          '',
          '  const sx = createSelectlet(idlUtils.wrapperForImpl(_ownerDocument));',
          '',
          '  return {',
          '    first(selector, context) {',
          '      return sx.first(selector, context);',
          '    },',
          '',
          '    select(selector, context) {',
          '      return sx.select(selector, context);',
          '    },',
          '',
          '    match(selector, element) {',
          '      return sx.matches(selector, element);',
          '    },',
          '',
          '    closest(selector, element) {',
          '      return sx.closest(selector, element);',
          '    },',
          '  };',
          '}',
          '',
