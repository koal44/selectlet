...
export function colorNameFromText(text: string): ColorName | undefined {
  return ColorNameByText[asciiLower(text)];
}

export function systemColorNameFromText(text: string): SystemColorName | undefined {
  return SystemColorNameByText[asciiLower(text)];
}
...
const ColorNameByText: { [name: string]: ColorName | undefined; } = {
...
const ColorRgba: Partial<Record<ColorName, number>> = {
...
const SystemColorNameByText: { [name: string]: SystemColorName | undefined; } = {
