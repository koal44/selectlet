...
import type { Scenario, TestCase } from '../../../scenario/harness';

const fixtures = {
  htmlTransitional: readFileSync('test/selectlet/scenarios/fixtures/slick/template-transitional.html', 'utf8'),
  htmlStandard: readFileSync('test/selectlet/scenarios/fixtures/slick/template-standard.html', 'utf8'),
  htmlAlmost: readFileSync('test/selectlet/scenarios/fixtures/slick/template-almost.html', 'utf8'),
  htmlQuirks: readFileSync('test/selectlet/scenarios/fixtures/slick/template-quirks.html', 'utf8'),
  xhtml: readFileSync('test/selectlet/scenarios/fixtures/slick/template.xhtml', 'utf8'),
  xml: readFileSync('test/selectlet/scenarios/fixtures/slick/template.xml', 'utf8'),
  svg: readFileSync('test/selectlet/scenarios/fixtures/slick/MooTools_Logo.svg', 'utf8'),
} as const;
