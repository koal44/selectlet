...
import type { Scenario, TestCase } from '../../../harness/browser/scenarios';

const fixtures = {
  htmlTransitional: readFileSync('test/selectlet/browser/fixtures/slick/template-transitional.html', 'utf8'),
  htmlStandard: readFileSync('test/selectlet/browser/fixtures/slick/template-standard.html', 'utf8'),
  htmlAlmost: readFileSync('test/selectlet/browser/fixtures/slick/template-almost.html', 'utf8'),
  htmlQuirks: readFileSync('test/selectlet/browser/fixtures/slick/template-quirks.html', 'utf8'),
  xhtml: readFileSync('test/selectlet/browser/fixtures/slick/template.xhtml', 'utf8'),
  xml: readFileSync('test/selectlet/browser/fixtures/slick/template.xml', 'utf8'),
  svg: readFileSync('test/selectlet/browser/fixtures/slick/MooTools_Logo.svg', 'utf8'),
} as const;
