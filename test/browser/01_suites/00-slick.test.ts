...
const fixtures = {
  ...
  htmlStandard: readFileSync('test/browser/fixtures/slick/template-standard.html', 'utf8'),
  htmlAlmost: readFileSync('test/browser/fixtures/slick/template-almost.html', 'utf8'),
  htmlQuirks: readFileSync('test/browser/fixtures/slick/template-quirks.html', 'utf8'),
  xhtml: readFileSync('test/browser/fixtures/slick/template.xhtml', 'utf8'),
  xml: readFileSync('test/browser/fixtures/slick/template.xml', 'utf8'),
  svg: readFileSync('test/browser/fixtures/slick/MooTools_Logo.svg', 'utf8'),
} as const;
