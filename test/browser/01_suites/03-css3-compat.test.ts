...
runScenarios('css3 compat', 'normal',  [
  ...
  },
  {
    ...
    cases: [
      ...
      { select: '.blox20[class="blox20 unitTest" s]', expect: { count: 1 }, browsers: ['firefox', 'webkit'] },
      { select: '.blox20[class="blox20 unitTest" s]', expect: { throws: true }, browsers: ['chromium'], engines: ['native'] },
      { select: '.blox21[class*="21 UN" i]', expect: { count: 1 } },
      { select: '.blox22[class*="22 unitt" s]', expect: { count: 0 }, browsers: ['firefox', 'webkit'] },
      { select: '.blox22[class*="22 unitT" s]', expect: { count: 1 }, browsers: ['firefox', 'webkit'] },
      { select: '.blox24[class^="BLOX" i]', expect: { count: 1 } },
      { select: '.blox25[class^="BLOX"]', expect: { count: 0 } },
      { select: '.blox25[class^="blox" s]', expect: { count: 1 }, browsers: ['firefox', 'webkit'] },
      { select: '.blox26[class$="tEST" i]', expect: { count: 1 } },
      { select: '.blox27[class$="TEst" s]', expect: { count: 0 }, browsers: ['firefox', 'webkit'] },
      { select: '.blox27[class$="Test" s]', expect: { count: 1 }, browsers: ['firefox', 'webkit'] },
