...
runScenarios('dir pseudo', 'normal', [
  {
    name: 'wpt html semantics selectors dir',
    // status: 'only',
    ...
    steps: [
      {
        setupPage: async (page) => {
          await page.evaluate(() => {
            (document.getElementById('ta3') as HTMLTextAreaElement).value = 'HEBREW';
          });
        },
        cases: [
          { select: ':dir(rtl)', expect: { ids: ['bdo1', 'bdi2', 'bdi4', 'span2', 'span5', 'span7', 'input-tel3', 'bdo4', 'ta1', 'pre1'] } },
          { select: ':dir(ltr)', expect: { ids: ['html', 'head', 'meta', 'title', 'link1', 'link2', 'script1', 'script2', 'script3', 'style', 'body', 'log', 'bdo2', 'bdi1', 'bdi3', 'span1', 'span3', 'span4', 'span6', 'input-tel1', 'input-tel2', 'bdo3', 'bdo5', 'ta2', 'ta3', 'pre2', 'script4'] } },
        ],
      },
      {
        setupPage: async (page) => {
